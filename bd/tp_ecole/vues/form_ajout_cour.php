<div class="formulaire">
    ...
    <?php } ?>
    <h3>Formulaire ajout de cour</h3>
    <hr>
    <form method="post" action="index.php?commande=ajoutCour">
        <div class="form-group">
            <label for="titre">Titre :</label>
            <input type="text" name="titre" value="<?= htmlentities($cour["titre"]) ?>" />
        </div>
        <div class="form-group">
            <label for="texte">Texte :</label>
            <input type="text" name="texte" value="<?= htmlentities($cour["texte"]) ?>" />
        </div>
        <div class="form-group">
